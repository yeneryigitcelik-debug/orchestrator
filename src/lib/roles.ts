...
export const SPAWN_ROLES: RoleMeta[] = [
  // --- core ---
  { role: "backend", label: "backend", group: "core", model: "opus", blurb: "API · iş mantığı · auth" },
  { role: "frontend", label: "frontend", group: "core", model: "opus", blurb: "UI · component · state" },
  { role: "db", label: "db", group: "core", model: "opus", blurb: "şema · migration · query" },
  ...
  { role: "performance", label: "performance", group: "specialist", model: "opus", blurb: "gecikme · N+1 · bundle" },
  { role: "database", label: "database", group: "specialist", model: "opus", blurb: "bütünlük · FK · race" },
  { role: "api", label: "api", group: "specialist", model: "opus", blurb: "kontrat · validation · CORS" },
  { role: "infrastructure", label: "infra", group: "specialist", model: "opus", blurb: "build · SSL · runtime" },
